...
describe "the Assembler item" do
  ...
  describe ":halt" do
    it "should stop processing the buffer, leaving it in place"
  end
  
  describe ":run" do
    it "should begin processing its buffer, to completion"
  end
  
  describe "step" do
    it "should process just one item from its buffer"
  end
  
  describe ":+" do
    it "should merge the contents and buffers separately"
  end
  
  describe ":give" do
    it "should produce a List"
    
    it "should merge the buffer with the contents before acting"
  end
