...
class DuckInterpreter
  ...
  def item_tree(array)
    id_tree = array.inject("(") do |tree,item|
      if [List,Connector].include? item.class
...
@all_functions = ["+","-","*","/","neg","¬","∧","∨","depth","inc","dec","eql","<",">","≤","≥","be","pop","swap",  "if", "greedy?", "greedy", "ungreedy", "do", "know?", "shatter", "copy", "(", ")", "push", "unshift", "pop", "shift", "reverse", "empty", "zap", "quote", "[]", "known", "trunc", "[]=", "give", "map", "users", "useful", "∪", "∩", "flatten", "snap", "rewrap_by", "to_bool", "to_int", "to_decimal", "rotate"]
