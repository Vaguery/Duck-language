...
training_data = {[0, 1, 0, 0, 6, 0]=>7, [9, 1, 10, 9, 1, 1]=>51, [1, 6, 4, 4, 0, 4, 7, 2]=>28, [9, 1, 6, 4, 10, 8, 1]=>64, [2, 0, 7, 2, 3, 0, 4, 0, 3, 0]=>21, [2, 4, 2, 0, 3, 2, 8, 1, 9, 1, 2]=>34, [5, 5, 3, 1, 1, 3, 3, 5, 4, 6, 10]=>49, [10, 8, 2, 3, 0, 5, 0, 5, 4]=>50, [1, 5, 10, 9, 0, 8, 1, 6, 4, 7]=>60, [1, 9, 4, 6, 1, 6, 0, 10, 10, 1, 3]=>66, [2, 1, 3, 0, 6, 3, 3, 0, 8, 1, 0, 1]=>28, [3, 2, 5, 0, 8, 0, 3, 6, 2, 2, 8, 0]=>39, [8, 1, 2, 2, 5, 4, 1, 5, 7, 0, 2, 5]=>42, [8, 0, 5, 0, 9, 1, 1, 3, 0, 7, 1, 8]=>44, [3, 1, 7, 0, 1, 1, 10, 7, 2, 9, 0]=>50, [7, 1, 8, 0, 6, 3, 9, 1, 5, 0, 8, 1]=>54, [7, 2, 6, 4, 10, 9, 0, 6, 4, 3, 6]=>79, [4, 3, 0, 9, 0, 1, 3, 0, 0, 4, 8, 1, 0, 0]=>33, [4, 2, 7, 2, 7, 0, 6, 1, 3, 2, 7, 1, 0, 3]=>45, [1, 0, 8, 0, 5, 3, 3, 7, 10, 0, 2, 3, 1]=>55, [2, 7, 6, 4, 4, 4, 9, 0, 6, 2, 3, 2, 7, 3, 6]=>69, [0, 7, 2, 8, 10, 4, 0, 0, 7, 7, 0, 8, 2, 10]=>79, [1, 4, 10, 9, 0, 1, 1, 9, 1, 10, 6, 3]=>83, [7, 3, 9, 1, 5, 4, 8, 0, 8, 0, 2, 6, 10, 7, 0]=>84, [10, 3, 5, 7, 3, 10, 10, 2, 6, 1, 2]=>97, [10, 7, 0, 10, 8, 2, 10, 4, 6, 3, 2]=>102, [3, 7, 5, 2, 0, 4, 6, 2, 1, 6, 5, 3, 0, 7, 3, 3]=>62, [4, 2, 8, 2, 9, 1, 3, 1, 3, 7, 6, 0, 4, 3, 0, 7]=>78, [6, 2, 2, 3, 3, 2, 3, 7, 8, 1, 2, 7, 10, 9, 1, 7]=>91, [4, 1, 8, 1, 0, 1, 6, 3, 0, 9, 9, 1, 6, 1, 1, 0, 1, 9, 2]=>69, [4, 1, 8, 0, 7, 3, 2, 7, 5, 4, 3, 7, 1, 2, 8, 2, 6, 0]=>79, [3, 4, 8, 0, 4, 5, 6, 4, 7, 1, 9, 0, 1, 3, 4, 6, 6, 1]=>85, [10, 8, 1, 0, 7, 1, 7, 5, 5, 10, 2, 8, 3, 2, 6, 4, 7]=>118}
...
puts performance_over_IO_pairs("x ∨ / < x ∧ ( 5 2 * -0 zap x ∨ * -3 9 depth x > / zap ∧ if ∧ 6 if if - x - x count < ) depth dec eql + ∧ if depth eql shatter ∨ x / ∨ zap eql / + -6 < * - depth < shatter * zap count -73 * x if + -5 ∨ ( ∨ zap < * if ∧ if / shatter > depth -6 if shatter 1 ∨ inc zap > shatter -5 x count count depth x count dec 8 x * shatter / 8 - * / count ∧ ∧ > -7 - depth +",training_data).inspect